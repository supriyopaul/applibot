          ...
          <div className="p-8">
            ...
            <Tabs className="mb-4">
              <TabList className="flex border-b border-gray-200 mb-6">
                <Tab className="px-6 py-2 font-medium text-gray-600 hover:text-indigo-600 cursor-pointer border-b-2 border-transparent hover:border-indigo-600 transition-colors" selectedClassName="border-b-2 border-indigo-600 text-indigo-600">
                  Save a New Resume
                </Tab>
                <Tab className="px-6 py-2 font-medium text-gray-600 hover:text-indigo-600 cursor-pointer border-b-2 border-transparent hover:border-indigo-600 transition-colors" selectedClassName="border-b-2 border-indigo-600 text-indigo-600">
                  View/Manage Resumes
